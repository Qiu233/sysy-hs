...
-- makeAnnoTypes :: String -> Name -> [Name] -> Q [Dec]
-- makeAnnoTypes prefix anno_type_name annotated_ = do
...
--                     pure [DataD [] (prefixed original) [] Nothing ctors_ annotateDerivings]
...
--                     pure [NewtypeD [] (prefixed original) [] Nothing ctor_ annotateDerivings]
